...
export default function App() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-500 font-sans">
        {/* Navbar */}
          ...
          <div className="max-w-2xl mx-auto bg-white dark:bg-gray-700 p-8 rounded-lg shadow-lg">
            {submitted ? (
              <p className="text-green-500 font-semibold text-center text-lg">
                ✅ Thank you! Your message and resume have been successfully submitted. We will get back to you shortly.
              </p>
            ) : (
