        ...
        {!isAdmin ? (
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <input
                      ...
                      required
                      className="p-3 rounded border border-gray-400 dark:border-gray-600 bg-gray-200 dark:bg-gray-800"
                    />
                    <input
                      type="email"
                      name="email"
                    ...
                    <textarea
                      ...
                      rows={5}
                      required
                      className="p-3 rounded border border-gray-400 dark:border-gray-600 bg-gray-300 dark:bg-gray-800"
                    />
                    ...
                    <button type="submit" className="bg-blue-500 text-white px-6 py-3 rounded font-semibold hover:bg-blue-600">
                      Submit
                    </button>
                  </form>
                )}
          ...
          <>
            ...
            <section className="py-20 px-6 md:px-20">
              ...
              <div className="overflow-x-auto bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
